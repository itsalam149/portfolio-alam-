  ...
  <main className="max-w-5xl mx-auto pt-20 sm:pt-24 pb-12 px-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="mb-4">This Refund Policy applies to purchases and services made through this website and to any related offerings or services provided by Faqre Alam. References to &quot;we&quot;, &quot;us&quot;, or &quot;our&quot; refer to Faqre Alam.</p>
          ...
          <p className="mb-2 text-sm">This Policy covers paid services, deposits, and fees charged for project work, consulting, and digital goods sold directly through this website.</p>
          ...
          <p className="mb-2 text-sm">To request a refund, please do the following:
            <ol className="list-decimal list-inside ml-5 mt-2">
              <li>Include an invoice/order number or proof of
                payment.</li>
              <li>Use the contact form on this website with your request and supporting documentation.
              </li>
          ...
          <p className="mb-2 text-sm">For refund requests or questions, please use the contact form on this website. General inquiries can also be made through the contact form.</p>
